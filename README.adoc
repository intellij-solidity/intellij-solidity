...
If you are only starting your way as an Intellij-Plugin developer, feel free to contact link:https://github.com/SerCeMan[me], and I'll help with the IDE
setup and guide you trough the code so that you will be able to make your first contribution and fix that annoying bug
