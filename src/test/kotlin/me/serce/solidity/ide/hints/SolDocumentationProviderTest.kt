...
class SolDocumentationProviderTest : SolTestBase() {
  ...
  fun testDocsForBuiltinFunction() = checkByText("""
        ...
        """,      """<div class='definition'><pre><b style='color:rgb(0,0,128)'>function</b> encode(<b style='color:rgb(0,0,128)'>data</b>)    <b style='color:rgb(0,0,128)'>returns</b> (<b style='color:rgb(0,0,128)'>bytes</b> <b style='color:rgb(0,0,128)'>memory</b>)</pre></div><div class='content'>
